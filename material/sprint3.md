...
4. **Team Contributions**:
   - Clearly outline each team member's contributions, including coding, testing, design, and documentation efforts. Utilize commit history and self-assessments as evidence.
...
- **Deployment**:
  - Deploy both the front-end and back-end components. Ensure the deployment process is well-documented so it can be replicated.

### **Week 8: Documenting and Evaluating Project Alignment**

- **Documentation**:
  - Create documentation **`for the API`**, including endpoint descriptions, request and response formats, authentication methods, and examples.
<!--
...
## Assessment Criteria (Total: 200 Points)
...
### 1. **Artifacts (90 Points)**
   ...
   - **Breakdown**:
     ...
     - **Back-End Code (45 Points)**: Self-assessment of code quality (10), API implementation (15), testing and coverage (10), documentation (10).

### 2. **Adherence to Scrum Process (30 Points)**
   - Participation in Scrum ceremonies and adherence to Scrum practices.
   - **Breakdown**:
     - **Daily Scrums (10 Points)**: Consistent participation and documentation of daily stand-ups.
