...
<p align="center">
  ...
  <img src="./material/img/qr-web-project.png" alt="Repo QR Code" width="200" height="200" />  
  <br>
...
**Note on Scope for This Sprint**

For this sprint, **connecting the frontend to the backend is intentionally out of scope**. The goal is to keep responsibilities clear and manageable:

- We are working with **separate frontend and backend teams**.  
- Each team should focus on **its own deliverables** and on defining a **clean interface**.  
- This structure helps prevent team members from feeling overwhelmed and ensures everyone can make solid progress within their area.
- Integration **will happen later** in the course:
  - During **Coding Marathon 3**, we'll connect the frontend and backend.  
  - In the **weeks 7 and 8**, we'll run several activities focused on integrating a full‑stack application.
